    ...
    <div class="grid grid-cols-12 gap-4">
      ...
      <div class="ltablet:col-span-8 col-span-12 gap-4 lg:col-span-8">
        <div class="flex flex-col gap-4">
              ...
              >
                ...
                <div class="space-y-1">
                  ...
                  >
                    ...
                    <span class="text-sm font-semibold text-success-500 ps-2"
                      >(+1.2%)</span
                    >
                  </BaseHeading>
                </div>
              ...
              >
                ...
                <div class="space-y-1">
                  ...
                  >
                    ...
                    <span class="text-sm font-semibold text-danger-500 ps-2"
                      >(-0.7%)</span
                    >
                  </BaseHeading>
                </div>
          ...
          <!-- Chart -->
          <div class="relative">
            <div class="absolute top-2 end-2 w-52">
              ...
              >
                ...
                <div class="flex items-center gap-2 pt-4">
                  ...
                  <div class="ms-auto flex items-center gap-1">
                    ...
                    >
                      <span>+{{ formatPrice(53.14) }}</span>
                      <span class="text-xs font-semibold text-success-500 ps-2"
                        >(+1.2%)</span
                      >
                    </BaseHeading>
                    <Icon
                ...
                <div class="flex items-center gap-2 pt-4">
                  ...
                  <div class="ms-auto flex items-center gap-1">
                    ...
                    >
                      <span>-{{ formatPrice(12.37) }}</span>
                      <span class="text-xs font-semibold text-danger-500 ps-2"
                        >(-0.7%)</span
                      >
                    </BaseHeading>
                    <Icon
        ...
        <div class="flex flex-col gap-4">
              ...
              <div class="space-y-5">
                <div class="flex items-center justify-between">
                  ...
                  <BaseParagraph
                    ...
                    >{{ formatPrice(2394.64) }}</BaseParagraph
                  >
                </div>
                <div class="flex items-center justify-between">
                  <BaseParagraph size="sm" class="text-muted-400"
                  ...
                  <BaseParagraph
                    ...
                    weight="semibold"
                    class="text-muted-800 dark:text-muted-100"
                    >{{ formatPrice(2789.12) }}</BaseParagraph
                  >
                </div>
                <div class="flex items-center justify-between">
                  <BaseParagraph size="sm" class="text-muted-400"
                  ...
                  <BaseParagraph
                    ...
                    weight="semibold"
                    class="text-muted-800 dark:text-muted-100"
                    >{{ formatPrice(2118.27) }}</BaseParagraph
                  >
                </div>
                <div class="flex items-center justify-between">
                  <BaseParagraph size="sm" class="text-muted-400"
                  ...
                  <BaseParagraph
                    ...
                    weight="semibold"
                    class="text-muted-800 dark:text-muted-100"
                    >{{ formatPrice(2091.14) }}</BaseParagraph
                  >
                </div>
                <div class="flex items-center justify-between">
                  <BaseParagraph size="sm" class="text-muted-400"
                    >% Change</BaseParagraph
                  >
                  <BaseParagraph
                    size="sm"
                    weight="semibold"
          ...
          <div class="relative">
            ...
            >
              ...
              <div class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                  <BaseParagraph size="sm" class="text-muted-400"
                    >Market price</BaseParagraph
                  >
                  <BaseParagraph
                    size="sm"
                    weight="semibold"
                    class="text-muted-800 dark:text-muted-100"
                    >{{ formatPrice(689.17) }}</BaseParagraph
                  >
                </div>
                <div class="flex items-center justify-between">
                  <BaseParagraph size="sm" class="text-muted-400"
                    >Commissions</BaseParagraph
                  >
                  <BaseParagraph
                    size="sm"
                    weight="semibold"
          ...
          >
            <div class="flex flex-col p-6">
              <div
                class="h-14 w-14 flex items-center justify-center rounded-full bg-white dark:bg-muted-900 border border-muted-200 dark:border-muted-800 mb-4"
              >
                <div
                  class="h-10 w-10 flex items-center justify-center rounded-full bg-white dark:bg-muted-900 border border-muted-200 dark:border-muted-800"
                >
                  <Icon
