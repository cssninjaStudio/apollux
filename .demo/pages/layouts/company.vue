  ...
  <div class="w-full">
    ...
    <div class="py-6 border-b border-muted-200 dark:border-muted-800">
      <div class="flex items-center gap-3">
        <div
          class="h-16 w-16 nui-mask nui-mask-blob shrink-0 flex items-center justify-center bg-muted-100 dark:bg-muted-900"
        >
          <Icon name="ph:buildings-duotone" class="w-7 h-7" />
        </div>
        <div>
          <BaseHeading
            as="h2"
    ...
    <div class="space-y-10">
      <!--Section-->
      <div class="grid md:grid-cols-12 gap-8 pt-6">
        <!--Column-->
        ...
        <div class="md:col-span-7">
          <BaseHeading
            ...
            size="xs"
            weight="medium"
            class="pb-4 px-4 border-b border-muted-200 dark:border-muted-800 text-muted-800 dark:text-muted-100"
          >
            Company info
          </BaseHeading>
          <div
            ...
            <div class="group">
              ...
              >
                <div>
                  ...
                  <BaseText size="sm">Acme LLC.</BaseText>
                </div>
                <Icon name="lucide:edit-3" class="ms-auto w-4 h-4" />
                <BaseText
                  size="xs"
                  weight="semibold"
                  class="text-primary-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                >
                  Edit
                </BaseText>
              </a>
            ...
            <div class="group">
              ...
              >
                <div>
                  ...
                  <BaseText size="sm">Acme Systems</BaseText>
                </div>
                <Icon name="lucide:edit-3" class="ms-auto w-4 h-4" />
                <BaseText
                  size="xs"
            ...
            <div class="group">
              ...
              >
                <div>
                  ...
                  <BaseText size="sm">hello@acme.io</BaseText>
                </div>
                <Icon name="lucide:edit-3" class="ms-auto w-4 h-4" />
                <BaseText
                  size="xs"
            ...
            <div class="group">
              ...
              >
                <div>
                  ...
                  <BaseText size="sm">+1 (612) 429-3263</BaseText>
                </div>
                <Icon name="lucide:edit-3" class="ms-auto w-4 h-4" />
                <BaseText
                  size="xs"
            ...
            <div class="group">
              ...
              >
                <div>
                  ...
                  <BaseText size="sm">@acmellc</BaseText>
                </div>
                <Icon name="lucide:edit-3" class="ms-auto w-4 h-4" />
                <BaseText
                  size="xs"
      ...
      <div class="grid md:grid-cols-12 gap-8 pt-6">
        ...
        <div class="md:col-span-7">
          <div
            class="pb-4 px-4 border-b border-muted-200 dark:border-muted-800"
          >
            <BaseHeading
              as="h3"
              size="sm"
            ...
            <div class="space-y-1">
              ...
              <BaseParagraph
                ...
                class="text-muted-500 dark:text-muted-400"
              >
                Parkston road, Block 2, Suite G23
              </BaseParagraph>
              <BaseParagraph
                size="sm"
                class="text-muted-500 dark:text-muted-400"
              >
                Los Angeles, CA 92841
              </BaseParagraph>
              <BaseParagraph
                size="sm"
                class="text-muted-500 dark:text-muted-400"
      ...
      <div class="grid md:grid-cols-12 gap-8 pt-6">
        ...
        <div class="md:col-span-5">
          <div class="w-full max-w-xs">
            ...
            <BaseParagraph size="sm" class="text-muted-500 dark:text-muted-400">
              This is the billing address for your cards and will appear on your
              documents
            </BaseParagraph>
          </div>
        </div>
