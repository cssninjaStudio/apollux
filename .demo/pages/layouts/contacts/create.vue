...
const zodSchema = z
  .object({
    ...
    contact: z.object({
      ...
      phone: z.string().min(1, VALIDATION_TEXT.EMAIL_REQUIRED),
                  ...
                  >
                    <div class="relative h-28 w-28">
                      <img
                        ...
                        alt="Upload preview"
                        class="bg-muted-200 dark:bg-muted-700/60 h-28 w-28 rounded-full object-cover object-center"
                      />
                      <img
                        v-else
                        :src="currentAvatar"
                        alt="Upload preview"
                        class="bg-muted-200 dark:bg-muted-700/60 h-28 w-28 rounded-full object-cover object-center dark:invert"
                      />
                      <div
                        v-if="files?.length && files.item(0)"
                      ...
                      >
                        <div class="">
                          <label class="nui-label pb-2 text-[0.825rem]"
                            >Gender</label
                          >
                          <div class="sm:grid-cols-3 grid gap-4">
                            <Field
                              v-slot="{
                                field,
                                errorMessage,
