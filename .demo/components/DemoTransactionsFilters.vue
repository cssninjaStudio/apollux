                  ...
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    >
                      ...
                      >
                        <button
                          type="button"
                          class="inline-flex items-center justify-center py-1.5 px-4 rounded-full font-sans text-xs text-muted-500 dark:text-muted-200 bg-white dark:bg-muted-900 border-2 border-muted-200 dark:border-muted-800 peer-checked:bg-primary-500/10 peer-checked:border-primary-500 peer-checked:text-primary-500 transition-colors duration-300"
                        >
                          {{ keyword }}
                        </button>
                      </BaseCheckboxHeadless>
