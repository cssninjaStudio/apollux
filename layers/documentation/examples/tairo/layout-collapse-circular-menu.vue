  ...
  <div class="w-full">
    <NuxtLink to="#" class="hover:[&>img]:!border-primary-500">
      <img
        ...
        src="/img/apps/apollux-layout-collapse-circular-menu.png"
        alt="Apollux circular menu"
      />
      ...
      <img
        ...
        src="/img/apps/apollux-layout-collapse-circular-menu-dark.png"
        alt="Apollux circular menu dark"
      />
    </NuxtLink>
  </div>
</template>
