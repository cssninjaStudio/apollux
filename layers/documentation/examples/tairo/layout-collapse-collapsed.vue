  ...
  <div class="w-full">
    <NuxtLink to="#" class="hover:[&>img]:!border-primary-500">
      <img
        ...
        src="/img/apps/apollux-layout-collapse-collapsed.png"
        alt="Apollux collapse layout"
      />
      ...
      <img
        ...
        src="/img/apps/apollux-layout-collapse-collapsed-dark.png"
        alt="Apollux collapse layout dark"
      />
    </NuxtLink>
  </div>
</template>
