<template>
  ...
  <!-- Modal component -->
  <ApolluxModal :open="isModalEndOpen" size="md" footer-align="end" @close="isModalEndOpen = false">
    <template #header>
      <!-- Header -->
      <div class="flex w-full items-center justify-between p-4 md:p-6">
        <h3 class="font-heading text-muted-900 text-lg font-medium leading-6 dark:text-white">
  ...
  <!-- Modal component -->
  <ApolluxModal :open="isModalBodyOpen" size="md" @close="isModalBodyOpen = false">
    <template #header>
      <!-- Header -->
      <div class="flex w-full items-center justify-between p-4 md:p-6">
        <h3 class="font-heading text-muted-900 text-lg font-medium leading-6 dark:text-white">
