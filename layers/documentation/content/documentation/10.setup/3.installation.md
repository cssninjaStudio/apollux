...
You should see the Apollux Welcome page, see how to [build your first page](/documentation/setup/first-page) guide to replace it.
:::
...
│   ├── layouts
│   │   └── default.vue # use Apollux sidebar layout as default
│   ├── README.md
...
│   └── tsconfig.json
├── layers
│   └── apollux # Contains Apollux shared ready-to-use components
│   └── apollux-collapse-layout # Contains Apollux collapse layout
```
...
---
The source of the main demo is separated from the Apollux source, 
...
│   ├── apollux # Contains Apollux shared ready-to-use components
│   └── apollux-sidebar-layout # Contains Apollux sidebar layout
│   └── apollux-collapse-layout # Contains Apollux collapse layout
│   └── apollux-topnav-layout # Contains Apollux topnav layout
```
