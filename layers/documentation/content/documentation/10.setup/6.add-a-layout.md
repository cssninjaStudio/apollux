...
- :doc-linker{to="ApolluxCollapseLayout"} :  
...
├── .app
├── layers
│   ├── apollux-layout-collapse # register 'collapse' layout
│   └── apollux-layout-sidebar # register 'sidebar' layout
│   └── apollux-layout-topnav # register 'topnav' layout
```
...
Instead of setting the layout on each page, you can create a `.app/layouts/default.vue` component that will be used as the default layout for all pages. In this component, you just have to include the main component of the layout you want to use, in this case we use :doc-linker{to="ApolluxCollapseLayout"}
