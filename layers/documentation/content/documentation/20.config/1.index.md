...
Like seen in the previous example, you can define the `NUXT_SECRET_KEY` value using an environment variable.
...
export default defineAppConfig({
  // apollux specific config
  apollux: {
    // app title suffix
    title: 'My app',

    // register apollux panels
    panels: [],
