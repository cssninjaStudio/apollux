...
components: 
  - AddonCarouselTeam
  - AddonCarouselIcons
description: Apollux ships with the swiper module for Nuxt. Use the component to display fancy and highly customizable carousels.
icon:
...
---
Build gorgeous carousels with Apollux using the Vue3 Carousel library. Check out this team carousel example.
