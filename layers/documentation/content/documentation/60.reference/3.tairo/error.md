---
title: ApolluxError
description: Apollux provides a simple way to show errors to the user. It uses the `ApolluxError` component to show the error.
components:
  - ApolluxError
icon:
...
---
title: Apollux error
demo: '#examples/apollux/error.vue'
---
