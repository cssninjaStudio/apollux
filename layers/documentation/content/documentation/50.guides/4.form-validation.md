...
description: Form validation is a way to check if the data entered by the user is valid. Apollux provides a simple way to validate forms using the `veevalidate` and `zod` libraries.
---

::doc-component-demo
---
title: Form validation
demo: '#examples/apollux/validation.vue'
---
