        ...
        children: [
          {
            ...
            children: [
              {
                item: {
                  name: 'ApolluxModal.vue',
                  icon: 'vscode-icons:file-type-vue',
                },
              },
              {
                item: {
                  name: 'ApolluxError.vue',
                  icon: 'vscode-icons:file-type-vue',
                },
              },
              {
          ...
          },
          {
            item: {
              name: 'app.config.ts',
              tooltip: 'Default app config for apollux',
              icon: 'vscode-icons:file-type-typescript',
            },
          },
          {
            item: {
              name: 'nuxt.schema.ts',
              tooltip: 'Default nuxt schema for apollux',
              icon: 'vscode-icons:file-type-typescript',
            },
          },
          {
            item: {
              name: 'nuxt.config.ts',
              tooltip: 'Default nuxt config for apollux',
              icon: 'vscode-icons:file-type-typescript',
            },
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                item: {
                  name: 'ApolluxSidebarLayout.vue',
                  icon: 'vscode-icons:file-type-vue',
                },
              },
              {
                item: {
                  name: 'ApolluxSidebarNavigation.vue',
                  icon: 'vscode-icons:file-type-vue',
                },
              },
              {
        ...
        children: [
          {
            ...
            children: [
              {
                item: {
                  name: 'ApolluxCollapseLayout.vue',
                  icon: 'vscode-icons:file-type-vue',
                },
              },
              {
                item: {
                  name: 'ApolluxCollapseNavigation.vue',
                  icon: 'vscode-icons:file-type-vue',
                },
              },
              {
                item: {
                  name: 'ApolluxCollapse...',
                  icon: 'vscode-icons:file-type-vue',
                },
              },
            ],
    ...
    children: [
      ...
      },
      {
        item: {
          ...
          icon: 'vscode-icons:file-type-vue',
          color: 'bg-lime-500',
          tooltip: 'from apollux-layout-sidebar layer',
        },
      },
      {
        item: {
      ...
      },
      {
        item: {
          ...
          icon: 'vscode-icons:file-type-vue',
          color: 'bg-pink-500',
          tooltip: 'from apollux-layout-collapse layer',
        },
      },
      {
        item: {
