  ...
  >
    <div>
      <BaseCard shape="rounded" class="p-8">
        ...
        >
          <ApolluxLogoText class="h-5 transition-colors duration-300" />
        </div>
        <BaseParagraph
          size="sm"
          class="text-muted-500 dark:text-muted-400 mb-4"
        >
          Apollux is a powerful Nuxt / Tailwind CSS Admin and Webapp UI Kit,
          built with Vue 3 and TypeScript.
        </BaseParagraph>
        <BaseText size="sm" class="text-muted-400 dark:text-muted-400">
          Apollux provides everything you need to build a modern web app or
          admin application. All basic components are built with Tailwind CSS
          and powered by Nuxt.
        </BaseText>
