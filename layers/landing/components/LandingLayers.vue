  ...
  <div class="dark:bg-muted-900 bg-white py-24">
    <div class="mx-auto w-full max-w-7xl px-4">
      <div class="mb-10 max-w-2xl">
        ...
        >
          Apollux is built on top on the Nuxt Layers concept. Layers can be seen
      ...
      <div class="ptablet:grid-cols-2 grid gap-6 sm:grid-cols-3">
        <LandingLayersBox
          ...
          color="indigo"
        >
          Apollux ships with a clean starter project where you can start writing
        ...
        <LandingLayersBox
          ...
          color="purple"
        >
          Apollux is built with Tailwind CSS and Shuriken UI. You can customize
        ...
        >
          Apollux ships with a lot of UI components, from the smallest parts
