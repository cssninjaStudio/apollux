        ...
        >
          ...
          <div class="aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1 -mt-6">
            <NuxtImg
              ...
              src="/img/apps/apollux-screen-full.png"
              alt="Apollux demo screenshot lightmode"
              format="webp"
              width="568"
              height="532"
              loading="lazy"
            ...
            <NuxtImg
              ...
              src="/img/apps/apollux-screen-full-dark.png"
              alt="Apollux demo screenshot darkmode"
              format="webp"
              width="568"
              height="532"
              loading="lazy"
