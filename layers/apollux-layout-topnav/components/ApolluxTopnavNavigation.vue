...
import type { LayoutDisplay } from './ApolluxTopnavLayout.vue'
  ...
  >
      ...
      <div class="flex h-20 w-full items-center justify-between">
        ...
        <div class="ltablet:flex hidden grow justify-center gap-x-6 lg:flex">
          ...
          >
            ...
            >
              <div
                class="text-muted-400 group-hover:bg-muted-100 group-hover:text-muted-600 dark:group-hover:bg-muted-800 dark:group-hover:text-muted-300 relative mx-auto flex h-11 w-11 items-center justify-center rounded-xl transition-colors duration-300"
              >
    ...
    <div class="ltablet:hidden flex grow justify-center gap-x-6 pb-4 lg:hidden">
      <div v-for="(item, index) in menuItems" :key="index" class="text-center">
        ...
        >
          <div
            class="text-muted-400 group-hover:bg-muted-100 group-hover:text-muted-600 dark:group-hover:bg-muted-700 dark:group-hover:text-muted-300 relative mx-auto flex h-12 w-12 items-center justify-center rounded-xl transition-colors duration-300"
          >
            <Icon :name="item.icon.name" :class="item.icon.class" />
          </div>
        </button>
    ...
    >
      ...
      <div
        ...
        class="ltablet:block ms-auto hidden lg:block"
      >
        <button
          type="button"
