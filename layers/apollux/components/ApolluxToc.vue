...
async function loadTocItemFromDom() {
  ...
  const elements = document.querySelectorAll('.apollux-toc-anchor')
...
<template>
  <div class="fixed flex flex-col justify-between pb-20 pe-1 ps-20 pt-2">
    <div class="w-52" v-if="toc.length">
      ...
      <nav
        class="nui-slimscroll nui-slimscroll-opaque relative max-h-[calc(100vh_-_220px)] overflow-y-auto overflow-x-hidden pb-10 font-sans text-[0.8rem] font-medium"
      >
        <ul>
