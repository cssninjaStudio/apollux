  ...
  <div class="mx-auto max-w-4xl pb-16">
    ...
    <BaseCard shape="curved" class="dark:!bg-muted-900 mb-4 p-8 sm:mb-6">
      ...
      <div class="space-y-2 pt-6 text-center">
        ...
        >
          Welcome to the Apollux app starter. You are here because you ran the
          <code
    ...
    <div class="mb-4 grid grid-cols-1 gap-4 sm:mb-6 sm:grid-cols-2 sm:gap-6">
      ...
      <NuxtLink
        to="https://apollux.cssninja.io/documentation"
        taget="_blank"
        rel="noopener noreferrer"
        class="relative"
      >
        ...
        >
          ...
          <div>
            ...
            >
              Reviewing Apollux's documentation is essential to get a grasp on
              all basic concepts used in this project and to get some code
              examples that you can immediately paste in.
            </BaseParagraph>
          </div>
        </BaseCard>
      </NuxtLink>
      ...
      <BaseCard class="dark:!bg-muted-900 p-6" shape="rounded">
        <BaseProse class="prose-p:my-0 max-w-full">
          <div>
            ...
            <pre><code>export default defineAppConfig({{app.apollux}})</code></pre>
          </div>
        </BaseProse>
      </BaseCard>
      <BaseCard class="dark:!bg-muted-900 p-6" shape="rounded">
          ...
          <div>
            <div class="flex gap-2 sm:items-center">
              ...
              <p>
                ...
                <a
                  href="https://apollux.cssninja.io/documentation"
                  target="_blank"
